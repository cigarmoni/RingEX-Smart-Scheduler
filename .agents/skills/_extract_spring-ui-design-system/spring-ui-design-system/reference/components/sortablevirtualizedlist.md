...
Sortable virtualized list

## Import

```tsx
import { SortableVirtualizedList } from '@ringcentral/spring-ui';
```
...
**Type**: `ComputeItemKey<UniqueIdentifier | { id: UniqueIdentifier; }, Omit<{}, "data" | "searchAndFocusItemHandler" | "isScrolling" | "scrollerRef" | "listRef" | ... 4 more ... | "keepInvisibleItems"> & { ...; } & Pick<...>>`
...
**Type**: `Components<UniqueIdentifier | { id: UniqueIdentifier; }, Omit<{}, "data" | "searchAndFocusItemHandler" | "isScrolling" | "scrollerRef" | "listRef" | ... 4 more ... | "keepInvisibleItems"> & { ...; } & Pick<...>>`
...
**Type**: `(items: ListItem<UniqueIdentifier | { id: UniqueIdentifier; }>[]) => void`
