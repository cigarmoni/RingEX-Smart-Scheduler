...
```tsx
import { ListItem } from '@ringcentral/spring-ui';
```
...
**Available keys**: `"root"`, `"content"`, `"divider"`, `"container"`, `"hover-actions"`, `"small"`, `"large"`, `"auto"`, `"highlighted"`, `"hoverable"`, `"clickable"`
