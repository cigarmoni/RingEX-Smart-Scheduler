...
const SUI_TEXT = "text-neutral-b0";
const SUI_MUTED = "text-neutral-b1";
const SUI_PRIMARY = "text-cobranding-f";
  ...
  return (
    <AppShell activeNav="Phone">
      <div className="relative flex h-full w-full flex-col">
        <header className="flex h-14 shrink-0 items-center justify-between border-b border-neutral-b0-t20 bg-white px-4">
          <h2 className="typography-title text-[20px] font-semibold text-neutral-b0">
            Phone
          </h2>
          <div className="flex items-center gap-2">
            <button
              type="button"
              className={`rounded-full p-2 hover:bg-neutral-b2 ${SUI_MUTED}`}
              aria-label="Search"
            >
        ...
        <section className="flex flex-1 items-center justify-center bg-neutral-b1">
        ...
        {view === "in-call" && (
          <div className="pointer-events-none fixed inset-0 z-[100] flex items-start justify-center overflow-auto px-3 py-4 sm:items-center sm:p-6">
            <div className="pointer-events-auto w-full max-w-[680px] shrink-0 overflow-hidden rounded-xl border border-neutral-b0-t20 bg-white shadow-lg sm:h-[518px] sm:w-[680px]">
              <div className="relative flex h-7 items-center border-b border-neutral-b0-t20 bg-neutral-b2 px-3">
              ...
              <div className="flex h-[calc(100%-28px)] flex-col sm:flex-row">
                <div className="flex w-full shrink-0 flex-col border-b border-neutral-b0-t20 sm:h-full sm:w-[280px] sm:border-b-0 sm:border-r">
                  <div className="flex items-center justify-between px-4 pt-3">
                    ...
                    <div className={`flex items-center gap-1 ${SUI_MUTED}`}>
                      <button className="rounded p-1 hover:bg-neutral-b2">
                  ...
                  <div className="relative grid grid-cols-3 gap-x-2 gap-y-3 px-6 py-5">
                    {controls.map((c) => (
                      ...
                      >
                        <span className={`flex h-12 w-12 items-center justify-center rounded-full bg-neutral-b2 hover:bg-neutral-b0-t10 ${SUI_TEXT}`}>
                  ...
                  <div className="flex items-center justify-center px-6 pb-4 pt-4">
                    <button
                      type="button"
                      onClick={endCall}
                      className="flex h-12 w-12 items-center justify-center rounded-full bg-danger text-white hover:bg-danger-f"
                    >
                ...
                <div className="flex w-full min-w-0 flex-1 flex-col sm:h-full sm:w-[400px] sm:flex-none">
                  <div className="flex items-center justify-between border-b border-neutral-b0-t20 px-4 pt-3">
                    <div className="flex items-center gap-5">
                      {(["CONTACT", "NOTES", "TEXT", "BOOKINGS"] as CallTab[]).map((tab) => {
                        ...
                        return (
                          ...
                          >
                            {tab}
                            {isActive && <span className="absolute inset-x-0 -bottom-px h-0.5 bg-cobranding-b" />}
                          </button>
                        );
                      })}
                    </div>
                  ...
                  {activeWidgetTab === "NOTES" ? (
                    <div className="flex flex-1 flex-col">
                      ...
                      <div className="flex-1 space-y-4 overflow-y-auto px-4 py-3 text-sm">
                        <div className="rounded-lg bg-neutral-b2 p-3">
                          ...
                          <button
                            ...
                            className="mt-2 inline-flex items-center gap-1 rounded px-1 py-0.5 text-[12px] font-medium text-cobranding-f hover:bg-cobranding-b/8"
                          >
