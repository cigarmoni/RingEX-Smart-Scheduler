...
const SmartSchedulerContent = ({
  ...
  return (
    <section className="flex min-w-0 flex-1 flex-col gap-4 p-3 sm:p-4">
      ...
      {showOnboarding ? (
        <div
          className="flex flex-1 rounded-xl border border-solid border-neutral-b0-t20 bg-white shadow-none"
          data-testid="card-onboarding"
        >
          <div className="flex flex-1 flex-col items-center justify-center gap-8 p-6 sm:gap-10 sm:p-8">
            <img
            ...
            />
            <h3
              className="w-full max-w-[600px] text-center text-headline text-neutral-b2"
            ...
            <ol className="flex w-full max-w-[520px] items-start justify-between gap-3 sm:gap-6">
              {[
                ...
                <li
                  ...
                  data-testid={testId}
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-cobranding-b/8 sm:h-14 sm:w-14">
                    <Icon className="h-5 w-5 text-cobranding-f sm:h-6 sm:w-6" />
                  </div>
                  <span className="text-subtitle-mini text-neutral-b2">
                    {label}
                  </span>
                </li>
              ))}
            ...
            <div className="flex w-full flex-col items-center gap-3">
              <Button
                ...
                className="h-9 px-4 py-0 text-subtitle"
        ...
        <>
          <nav className="flex flex-wrap items-center gap-2 px-1 pt-0.5">
            {tabs.map((tab) => (
              <Button
                ...
                className={`h-9 rounded-full px-4 py-2 text-subtitle-mini ${
                  activeTab === tab
                    ? "bg-neutral-b2 border-neutral-b0-t20"
                    : "bg-white hover:bg-neutral-b2 border-neutral-b0-t20"
                }`}
              >
                {tab}
              </Button>
          ...
          {isPostPurchase ? (
            <div className="flex flex-1 rounded-xl border border-solid border-neutral-b0-t20 bg-white shadow-none">
              <div
              ...
              >
                <CalendarMd className="h-10 w-10 text-neutral-b1" />
                <h3 className="text-headline text-neutral-b2">
                  Nothing here yet
                </h3>
            ...
            <div className="flex flex-1 rounded-xl border border-solid border-neutral-b0-t20 bg-white shadow-none">
              <div className="flex flex-1 flex-col items-center justify-center gap-6 p-6 sm:gap-8 sm:p-8">
                <img
                  className="h-24 w-24 sm:h-[120px] sm:w-[120px]"
                  alt="Calendar MD"
                  src="/figmaAssets/calendar-mark-orange.svg"
                ...
                <div className="flex w-full max-w-[600px] flex-col items-center gap-3 sm:gap-4">
                  <h3 className="w-full text-center text-headline text-neutral-b2">
                    Add online booking to your business
                  </h3>
                  <p className="w-full text-center text-title text-neutral-b1">
