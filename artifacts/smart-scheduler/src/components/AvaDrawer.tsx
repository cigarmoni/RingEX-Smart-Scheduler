  ...
  return (
    <>
      <aside
        ...
        className="relative z-30 flex w-[400px] shrink-0 flex-col border-l border-neutral-b0-t20 bg-white"
      >
        <header className="flex items-start gap-2 px-4 py-2 border-b border-neutral-b0-t20">
          <div className="flex min-w-0 flex-1 items-center gap-2.5">
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              <h3 className="truncate typography-subtitle text-neutral-b0">
                Ask AVA
              </h3>
              {subtitle && (
                <p
                  data-testid="text-ava-subtitle"
                  className="truncate text-[12px] leading-4 text-neutral-b2"
                >
                  {subtitle}
                </p>
              )}
          ...
          <div className="flex items-center gap-1">
            ...
            >
              <EditMd className="h-4 w-4 text-neutral-b0" />
            </Button>
            <Button
              variant="text"
              className="h-8 w-8 rounded-full p-0 hover:bg-[#0000000a] min-w-0"
            ...
            >
              <OverflowVerticalMd className="h-4 w-4 text-neutral-b0" />
            </Button>
            ...
            >
              <Xmd className="h-4 w-4 text-neutral-b0" />
            </Button>
          </div>
        </header>
        ...
        {view.kind === "empty" ? (
          <div className="flex flex-1 flex-col items-center overflow-y-auto px-4 pt-16">
            ...
            <h4 className="mt-4 text-center text-headline font-semibold text-neutral-b0">
            ...
            <div className="mt-4 flex w-full flex-col gap-2">
              {suggestedPrompts.map((prompt, i) => (
                <button
                  ...
                  className="flex min-h-[44px] w-full items-center gap-1.5 rounded-md border-[1.2px] border-solid border-neutral-b0-t20 px-3.5 py-2.5 text-left hover:bg-neutral-b2"
                >
                  <span className="pr-1 text-base font-semibold leading-5 text-neutral-b1">👉</span>
                  <span className="flex-1 typography-descriptorMini text-[12px] font-medium leading-[17px] text-neutral-b0">
                    {prompt}
                  </span>
                </button>
              ))}
              <div className="flex justify-end pt-1">
                <button
                  ...
                  className="flex items-center gap-1 rounded px-1 text-[12px] font-medium leading-[17px] text-cobranding-f hover:underline"
                >
                  View more prompts
          ...
          >
            <div className="flex justify-end">
              <div
                ...
                className="max-w-[85%] rounded-2xl rounded-tr-sm bg-cobranding-b px-3 py-2 text-[14px] leading-5 text-white"
              >
                {view.prompt}
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[14px] font-semibold leading-5 text-neutral-b0">AVA</span>
              <span className="text-neutral-b0-t20">|</span>
              <span data-testid="text-ava-time" className="text-[12px] leading-4 text-neutral-b2">
                {view.replyTime}
              </span>
            </div>
            <p
              data-testid="text-ava-reply"
              className="whitespace-pre-line text-[14px] leading-5 text-neutral-b0"
            >
              {AVA_REPLY}
            </p>
            <div className="flex items-center justify-end gap-2 pt-1">
              <Button
                ...
                className="h-8 rounded-full !border-cobranding-f !text-cobranding-f px-4 py-0"
              >
                Not now
              </Button>
              <Button
                ...
                return (
                  <div key={entry.id} className="flex flex-col gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[14px] font-semibold leading-5 text-neutral-b0">AVA</span>
                      <span className="text-neutral-b0-t20">|</span>
                      <span className="text-[12px] leading-4 text-neutral-b2">{entry.time}</span>
                    </div>
                    <p
                      data-testid="text-ava-share-prompt"
                      className="text-[14px] leading-5 text-neutral-b0"
                    >
        ...
        <div className="px-3 pb-2 pt-2">
          <form
            ...
            className="flex items-center gap-2 rounded-2xl border border-solid border-neutral-b0-t20 bg-white px-3 py-2 focus-within:border-cobranding-f"
          >
            <input
              value={message}
              ...
              className="flex-1 bg-transparent typography-mainText text-neutral-b0 placeholder:text-neutral-b2 focus:outline-none"
            />
            <button
              type="submit"
              ...
              className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-transparent text-neutral-b2 disabled:cursor-not-allowed enabled:bg-cobranding-b enabled:text-white enabled:hover:bg-[#0037be]"
            >
              <ArrowUpBorderMd className="h-4 w-4" />
            </button>
          </form>
          <p className="mt-2 text-center text-[11px] leading-4 text-neutral-b2">
...
const ShareBookingForm = ({ onCancel, onContinue }: ShareBookingFormProps): JSX.Element => {
  ...
  return (
    <div
      ...
      className="flex flex-col gap-3 rounded-xl border border-solid border-neutral-b0-t20 bg-white p-3"
    >
      <div className="flex flex-col gap-1.5">
        <label className="text-[12px] font-semibold leading-4 text-neutral-b1">
          Select booking type
        </label>
        <Select 
          value={bookingId} 
          onChange={(e) => setBookingId(e.target.value as string)}
          className="h-9 rounded-md bg-white text-[14px] text-neutral-b0"
